...
Every trap has a lure. The mouse trap has the cheese. The perfectionist's trap is the most sinister of all because its lure is not pleasure. It is *virtue*.
...
This is the **polish loop**. Fix one thing, find two more. The loop never ends, because there is always another flaw. A finished piece of work is not a piece of work with no flaws; it is a piece of work whose flaws you have agreed to live with. The perfectionist refuses to make that agreement, and so the work never finishes.

The trap is also a time trap. Perfectionists believe they are making the work better. Sometimes they are. But they are also making it *later*. There is a cost to every hour of polishing that has nothing to do with quality: the cost of the work still undone, the deadline creeping closer, the opportunities passing by while you refine a paragraph nobody has asked to see yet.
...
The way out of a trap is to see it. That is the whole of my method, in a sentence: **you cannot escape a trap you refuse to admit exists.**

Your standards are not protecting your work. They are imprisoning it. Every hour you spend polishing is an hour stolen from the project that needs you to move forward. You have been inside this trap so long that you have begun to think of it as your home. It is not your home. It is a cage with a comfortable-looking door, and the door has always been unlocked.

**EXERCISE: Name the Trap**

Put the book down. Take your paper. Write the name of one project you are currently polishing. Now write down the last three things you "fixed" on it. For each fix, ask yourself: *Did this need fixing, or did I just want it to be perfect?* Be honest. One of them, probably, genuinely needed the fix. The other two were the trap talking.

Now write down what you could ship today if you simply stopped fixing. That is the way out.
